                          ...
                          content: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('LocalStorage: ${info['hasLocalStorage']}'),
                                Text('Taille localStorage: ${info['localStorageSize']} bytes'),
                                if (info['error'] != null)
                                  Text('Erreur: ${info['error']}', style: const TextStyle(color: AppTheme.error)),
                              ],
                            ),
                          ),
                          actions: [
