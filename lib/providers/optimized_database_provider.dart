...
import '../services/optimized_web_database.dart';
import '../utils/poids_utils.dart';

class OptimizedDatabaseProvider with ChangeNotifier {
  final OptimizedWebDatabase _db;
  ...
  OptimizedDatabaseProvider() : _db = OptimizedWebDatabase() {
    _init();
  }

  static final OptimizedDatabaseProvider instance = OptimizedDatabaseProvider._();
  OptimizedDatabaseProvider._() : _db = OptimizedWebDatabase() {
    _init();
  }
  ...
  Future<void> _init() async {
    try {
      ...
      print('✅ OptimizedDatabaseProvider initialized');
    } catch (e) {
      print('❌ Error initializing OptimizedDatabaseProvider: $e');
    }
  }
